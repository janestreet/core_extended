...
val of_local_string : string -> t [@@zero_alloc]
val to_local_string : t -> string [@@zero_alloc]
val of_substring : string -> pos:int -> len:int -> t [@@zero_alloc]
val to_local_bytes : t -> Bytes.t [@@zero_alloc]
val max_length : int
val is_valid_length : int -> bool [@@zero_alloc]
val is_valid_string : string -> bool [@@zero_alloc]
