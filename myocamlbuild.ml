(* OASIS_START *)
(* DO NOT EDIT (digest: 4c4c3a0e5ec1ccda21e965b6167110fe) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("selector_lib", ["selector/src"], []);
          ("janecheck_kernel", ["janecheck_kernel/src"], []);
          ("janecheck", ["janecheck/src"], []);
          ("core_extended", ["src"], [])
       ];
     lib_c = [("core_extended", "src", ["src/fork_exec.h"; "src/config.h"])];
     flags =
       [
          (["oasis_library_core_extended_ccopt"; "compile"],
     ...
     includes =
       [
          ("test", ["src"]);
          ("src", ["janecheck/src"]);
          ("janecheck/src", ["janecheck_kernel/src"])
       ]
  }
  ;;
