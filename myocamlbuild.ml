(* OASIS_START *)
(* DO NOT EDIT (digest: 638df89e4ff854f535ab2f3ac6dbfd71) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("core_extended", ["lib"], [])];
     lib_c = [("core_extended", "lib", ["lib/fork_exec.h"; "lib/config.h"])];
     flags =
       [
          (["oasis_library_core_extended_ccopt"; "compile"],
            [(OASISExpr.EBool true, S [A "-ccopt"; A "-Ilib"])])
       ];
