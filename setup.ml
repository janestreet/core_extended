(* OASIS_START *)
(* DO NOT EDIT (digest: e027e7c6eb63a256935df43a1df31581) *)
(*
...
(* # 21 "/mnt/local/sda1/jdimino/opam-tmp/system/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     doc = [("core_extended", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("core_extended", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("test_runner",
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\143\012(\222\006\024\\\148\210GJ\138-\222\215\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
