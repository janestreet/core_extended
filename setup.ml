(* OASIS_START *)
(* DO NOT EDIT (digest: 41f199f620dab1360b6c5435d78e0618) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          conf_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("lib/detect.sh", [])))];
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\021\221\168C\176\185\230\237\015PB+\166\222\2303";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
