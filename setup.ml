(* OASIS_START *)
(* DO NOT EDIT (digest: 3af28a38af117494ba9c838a399688fc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/core_extended";
                  ...
                  },
                   {
                      ...
                      flag_default =
                        [
                           ...
                           (OASISExpr.EFlag "linux_possible", true)
                        ]
                   });
               Flag
                 ({
                     cs_name = "posix-timers";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "Enable POSIX timers";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "posix_timers_possible", true)
                        ]
                   });
               Library
                 ({
                     cs_name = "selector_lib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Selector"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "core_extended";
                      lib_findlib_name = Some "selector";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "janecheck_kernel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "core_extended";
                      lib_findlib_name = Some "janecheck_kernel";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "janecheck/src";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("comparelib.syntax", None);
                           FindlibPackage ("core_kernel", None);
                           InternalLibrary "janecheck_kernel";
                           FindlibPackage ("pa_ounit.syntax", None);
                           FindlibPackage ("pa_test.syntax", None);
                           FindlibPackage ("sexplib.syntax", None);
                           FindlibPackage ("threads", None)
                   ...
                   {
                      lib_modules =
                        ["Generator"; "Jc"; "Jc_intf"; "Observer"; "Std"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "core_extended";
                      lib_findlib_name = Some "janecheck";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("sexplib.syntax", None);
                           FindlibPackage ("sexplib_num", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\022\025\004\030\2416\225|\137\251\249\150\160\007{\194";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
